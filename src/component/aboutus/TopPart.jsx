    ...
    return (
        <section className="d-flex flex-column">
            ...
            <article className={styles["aboutUs-top-content"]}>
                ...
                <div data-aos="fade-left" className={styles["aboutUs-top-img"]+ " ms-2"}>
                    <img className={styles["aboutUs-top-img"]} src="/imgs/about-1.png" alt="beauty-pic" />
                </div>

                <div data-aos="fade-right" className={" text-center"}>
                    <h4>به سایت سالن زیبایی خوش آمدید</h4>
